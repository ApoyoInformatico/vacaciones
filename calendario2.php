...
<head>
  ...
  <title>Calendario</title>
    <style>
        ...
        #calendario {
            margin: 0 auto;
            width: 900px; /* Ancho total del calendario */
            text-align: left;
        }
        .fila {
            margin-bottom: 20px;
...
var dataToSend = {
    fecha1: '2024-03-12',
    fecha2: '2024-03-15',
    // Agrega aquí todas las fechas que necesites enviar
};

// Realizar la petición AJAX
$.ajax({
    url: 'guardar_dias.php',
    type: 'POST', // O el método que estés utilizando en tu script PHP
    data: JSON.stringify(dataToSend),
    contentType: 'application/json',
    success: function(response) {
        console.log(response); // Mostrar la respuesta del servidor en la consola del navegador
    },
